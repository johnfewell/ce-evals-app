...
- [ ] fix profile page for Instructors
...
- [x] Make a report for classes so that instructors can see data for their class in a view, eg courses/2/report
...
- [x] make an assignment page for admin
- [ ] DRY it
- [ ] Partial it
- [ ] Style
